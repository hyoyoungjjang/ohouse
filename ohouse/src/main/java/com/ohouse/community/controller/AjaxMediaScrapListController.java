...
/**
 * Servlet implementation class AjaxMediaScrapListController
 */
@WebServlet("/mediaScrap.co")
public class AjaxMediaScrapListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxMediaScrapListController() {
        super();
...
int boardId = Integer.parseInt(request.getParameter("bid"));
		...
		ArrayList<Scrap> list = service.selectMediaScrap(boardId);
