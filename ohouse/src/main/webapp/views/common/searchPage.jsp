    ...
    <% String contextPath=request.getContextPath(); %>
        ...
        <body>
            ...
            <article id="search-container">
                <!-- 상품 섹션 -->
                <section class="search-content item">
                    <c:if test="${}">
                            ...
                            <article class="search-project-item">
                                ...
                                <div class="search-project-item-info">
                                    ...
                                    <div class="search-project-item-info-user">
                                        ...
                                        <span class="search-project-item-info-user-nickname">닉네임이들어갑니다</span>
                                        <div class="search-project-item-info-status">스크랩 1,665 &#183; 조회 39,146</div>
                                    </div>
                                </div>
                            </article>
                        </div>
