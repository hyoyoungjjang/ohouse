...
----------------------------------------- REPLY ------------------------------------------
INSERT INTO REPLY (REPLY_ID, REPLY_TEXT, REPLY_CREATE_DATE, BOARD_ID, MEMBERS_NO) VALUES (SEQ_REPID.NEXTVAL, '퍼가요', SYSDATE, 1, 3);
INSERT INTO REPLY (REPLY_ID, REPLY_TEXT, REPLY_CREATE_DATE, BOARD_ID, MEMBERS_NO) VALUES (SEQ_REPID.NEXTVAL, '잘보고갑니다', SYSDATE, 2, 3);

----------------------------------------- REVIEW ------------------------------------------
INSERT INTO REVIEW (REVIEW_ID, RATING, REVIEW_DETAIL, HELPFUL, REVIEW_CREATE_DAY, PRODUCT_ID, MEMBERS_NO)
