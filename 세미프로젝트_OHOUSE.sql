...
SELECT P.PRODUCT_NAME, OC1.OPTIONS_CATEGORY, ON1.OPTIONS_NAME
FROM PRODUCT P
JOIN PRODUCT_OPTIONS PO ON P.PRODUCT_ID = PO.PDOPT_PRODUCT_ID
JOIN OPTIONS_CATEGORY OC1 ON PO.PRODUCT_OPTIONS_ID = OC1.OPTIONS_PDOPT_ID
JOIN OPTIONS_NAME ON1 ON OC1.OPTIONS_NO = ON1.OPTIONS_NAME_OPT_NO
