...
CREATE TABLE "MEMBERS" (
	...
	"MEMBERS_NAME"	VARCHAR2(20) CONSTRAINT NT_MEM_NAME NOT NULL,
	"MEMBERS_BIRTH"	DATE NULL,
	"MEMBERS_PHONE"	VARCHAR2(20) CONSTRAINT NT_MEM_PHONE NOT NULL,
	"MEMBERS_EMAIL"	VARCHAR2(50) CONSTRAINT NT_MEM_EMAIL NOT NULL,
	"GENDER"	CHAR(1)	CONSTRAINT NT_MEM_GENDER NOT NULL,
	"MEMBERS_TYPE"	VARCHAR2(20) CONSTRAINT NT_MEM_TYPE NOT NULL,
...
-- =========================================================================================================================
-- 트리거 부분
-- 주문 시 PRODUCT.AMOUNT값 - ORDERS.ORDERS_AMOUNT값
...
VALUES (SEQ_MEMID.NEXTVAL, 'member1', 'password1', '사용자1', TO_DATE('1990-01-01', 'YYYY-MM-DD'), '010-1111-2222', 'user1@example.com', 'M', '일반회원', NULL, NULL, NULL, NULL, NULL, NULL, 'Y');

-- BOARD 테이블에 더미 데이터 삽입
INSERT INTO BOARD (BOARD_ID, BOARD_TITLE, BOARD_VIEWS, BOARD_CREATE_TIME, BOARD_TYPE, BOARD_CONTENT, FILTER_TYPE, FILTER_AREA,FILTER_FAMILY, FILTER_WORKER, MEMBERS_NO)
VALUES (SEQ_BODID.NEXTVAL, '게시글 제목 1', 100, SYSDATE, '공지', '게시글 내용 1', '주거형태1', 100, '가족형태', '작업자1', 1);

-- PRODUCT 테이블에 더미 데이터 삽입
INSERT INTO PRODUCT (PRODUCT_ID, PRODUCT_NAME, PRODUCT_PRICE, PRODUCT_SALES, STOCK, DELIVERY_DATE, PRODUCT_THUMBNAIL, PRODUCT_IMG, PRODUCT_CONTENT, PRODUCT_CREATE_TIME, MEMBERS_NO, PRODUCT_CATEGORY)
VALUES (SEQ_PDID.NEXTVAL, '상품명 1', '10000원', '1000개', 500, 3, '썸네일 이미지 주소', '상품 이미지 주소', '상품 내용 1', SYSDATE, 1, 1);
...
-- BOARD_MEDIA 테이블에 더미 데이터 삽입
INSERT INTO BOARD_MEDIA (MEDIA_ID, MEDIA_TYPE, MEDIA_SRC, BOARD_ID)
VALUES (SEQ_MEDID.NEXTVAL, 1, '미디어 주소 1', 1);
