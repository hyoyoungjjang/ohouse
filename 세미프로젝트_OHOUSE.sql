...
VALUES (SEQ_BODID.NEXTVAL, '오늘의집 클론 코딩', 100, SYSDATE, '우리집을 소개합니다', '블라블라', '아파트', 30, '싱글라이프', '리모델링' , '전문가', 3);
...
VALUES (SEQ_PDID.NEXTVAL, 'LG 냉장고', 3000000, 100, 500, 3, 5, 'LG전자에서 만든 냉장고입니다', SYSDATE, 1, 1);

INSERT INTO PRODUCT (PRODUCT_ID, PRODUCT_NAME, PRODUCT_PRICE, PRODUCT_SALES, STOCK, DELIVERY_DATE, SALE, PRODUCT_CONTENT, PRODUCT_CREATE_TIME, MEMBERS_NO, PRODUCT_CATEGORY)
VALUES (SEQ_PDID.NEXTVAL, '동원 참치', 10000, 1000, 500, 3, 15, '맛있는 동원 참치', SYSDATE, 1, 2);
...
VALUES (SEQ_PDID.NEXTVAL, '옷걸이', 8000, 250, 500, 3, '옷걸이가 8천원!', SYSDATE, 1, 2);
...
INSERT INTO SCRAP (SCRAP_ID, SCRAP_TYPE, MEMBERS_NO, BOARD_ID, MEDIA_ID, PRODUCT_ID, SCRAP_CREATE_TIME)
VALUES (SEQ_SCRID.NEXTVAL, 1, 1, 1, 1, 1, SYSDATE);