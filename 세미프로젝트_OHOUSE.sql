...
CREATE TABLE "MEMBERS" (
	...
	"MEMBERS_TYPE"	NUMBER DEFAULT 1 CONSTRAINT NT_MEM_TYPE NOT NULL,
...
COMMENT ON COLUMN BOARD_MEDIA.MEDIA_STATUS IS '미디어 상태';
------------------------------------------------------------------
...
VALUES (SEQ_PDID.NEXTVAL, '상품명 1', '10000원', 1000, 500, 3, '썸네일 이미지 주소', '상품 이미지 주소', '상품 내용 1', SYSDATE, 1, 1);
